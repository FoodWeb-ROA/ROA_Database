...
CREATE OR REPLACE VIEW "public"."kitchen_subscription_status" WITH ("security_invoker"='true') AS
...
COMMENT ON VIEW "public"."kitchen_subscription_status" IS 'Unified view joining stripe_customer_links with stripe.subscriptions (synced by Stripe Sync Engine).';
