-- ============================================================================
-- Fix get_kitchen_preparations_for_parser directions type cast
-- ============================================================================
-- The function has a type mismatch: r.directions is text[] but COALESCE 
-- expects jsonb. Need to cast text[] to jsonb using to_jsonb().
-- ============================================================================
...
BEGIN
    SELECT jsonb_agg(
        jsonb_build_object(
            ...
            'serving_size_yield', r.serving_or_yield_amount,
