-- ============================================================================
-- Fix get_kitchen_preparations_for_parser column references
-- ============================================================================
-- The function references columns that don't exist or were renamed:
-- - r.language (doesn't exist in recipes table)
-- - r.cook_notes (actual column is cooking_notes)
-- - r.serving_size_yield (renamed to serving_or_yield_amount)
-- ============================================================================
...
BEGIN
    SELECT jsonb_agg(
        jsonb_build_object(
            ...
            'language', 'EN',  -- recipes table doesn't have language column, default to EN
            ...
            'cook_notes', r.cooking_notes,  -- Fixed: cooking_notes not cook_notes
            'serving_size_yield', r.serving_or_yield_amount,  -- Fixed: renamed column
